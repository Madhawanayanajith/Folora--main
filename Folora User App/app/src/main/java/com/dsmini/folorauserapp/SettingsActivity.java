...
public class SettingsActivity extends AppCompatActivity {
    ...
    private EditText username,userNIC,userphone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userphone = findViewById(R.id.set_profile_phone);
    ...
    private void UpdateSettings() {
        ...
        {
            Toast.makeText(SettingsActivity.this,"Please write your phone number first...",Toast.LENGTH_SHORT).show();
        ...
        } else
        {
            ...
            profileMap.put("number",userPhone);
        ...
        Refdatabase.child("Users").child(currentUserrID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists() && dataSnapshot.hasChild("name") && dataSnapshot.hasChild("image"))
                {
                    ...
                    String retriveuserphone=dataSnapshot.child("number").getValue().toString();
                    ...
                    userphone.setText(retriveuserphone);
                ...
                {
                    String retrieveusername=dataSnapshot.child("name").getValue().toString();
                    String retrieveuserstatus=dataSnapshot.child("number").getValue().toString();
                    String retrieveuserNIC=dataSnapshot.child("NIC").getValue().toString();
                    String retriveuserphone=dataSnapshot.child("number").getValue().toString();
